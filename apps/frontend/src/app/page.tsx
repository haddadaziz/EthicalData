...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 relative overflow-hidden font-sans selection:bg-red-600 selection:text-white">
      ...
      {/* FOOTER                                     */}
      {/* ═══════════════════════════════════════════ */}
      <footer className="relative z-10 bg-white text-slate-600 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="text-left space-y-4 md:min-w-[400px]">
            ...
            <div className="text-sm space-y-3">
              <p><span className="font-bold text-slate-900">Email :</span> contact@ethicaldatasecurity.ma</p>
              <p><span className="font-bold text-slate-900">Tél :</span> +212 664 244 343 // +212 520 572 631</p>
              <p><span className="font-bold text-slate-900">Adresse :</span> Bureau 305, Technopark Casablanca</p>
            </div>
          </div>
        ...
        <div className="w-full bg-slate-50 py-5 border-t border-slate-200">
          <div className="max-w-7xl mx-auto px-6 flex items-center">
            <p className="text-sm text-slate-500">© 2025 Ethical Data Security - Tous droits réservés.</p>
          </div>
        </div>
      </footer>
