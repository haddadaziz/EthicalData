          ...
          >
            {filteredResources.map((res: any) => {
              ...
              return (
                <div 
                  key={res.id}
                  className="bg-white hover:bg-white shadow-sm border border-slate-200/80 hover:border-slate-200 rounded-3xl p-6 transition-all duration-300 flex flex-col justify-between group text-left relative overflow-hidden"
                >
