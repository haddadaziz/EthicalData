...
export default function SettingsPage() {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8 py-8">
            <div>
                <h1 className="text-2xl font-black text-slate-950 tracking-tight">Paramètres</h1>
                <p className="text-sm text-slate-500 font-medium mt-1">Gérez vos préférences de notification et la visibilité de votre profil.</p>
            </div>
