...
import { BookOpen, Clock, Users, Award, ChevronRight, Search, Play, CheckCircle, FileText } from 'lucide-react';
                                ...
                                return (
                                    <div key={insc.id} className="group bg-white border border-emerald-200/80 rounded-2xl overflow-hidden shadow-xs hover:shadow-lg transition-all duration-300 flex flex-col">
                                        ...
                                        <div className="p-4 flex-1 flex flex-col gap-2">
                                            ...
                                            <div className="flex items-center gap-1.5 mt-auto pt-2 text-[10px] text-slate-500 font-semibold">
