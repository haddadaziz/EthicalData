                        ...
                        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3">
                            ...
                            {!profile.roles.some(r => r.nom === 'FORMATEUR' || r.nom === 'SUPER_ADMIN' || r.nom === 'ADMIN') && (
                                <button
                                    ...
                                    className="px-4 py-1.5 bg-emerald-500 hover:bg-emerald-600 text-white font-extrabold text-[9px] rounded-full uppercase tracking-wider transition-all duration-200 cursor-pointer shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/30 active:scale-95"
                                >
                                    Devenir Formateur
                                </button>
                            )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <motion.div
                        ...
                        className="bg-white border border-slate-200/60 rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden"
                    >
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                                ...
                                <span className="px-2.5 py-0.5 bg-emerald-50 text-emerald-700 font-extrabold text-[9px] rounded-full border border-emerald-100">
                                    ...
                                    {profile.obtainedCertifications.map((cert: any, i: number) => {
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                className="flex items-center gap-3 p-3 bg-slate-50/80 border border-slate-100 rounded-2xl hover:shadow-sm hover:border-emerald-100 transition-all duration-200 group"
                                            >
                    ...
                    >
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                                ...
                                <span className="px-2.5 py-0.5 bg-blue-50 text-blue-700 font-extrabold text-[9px] rounded-full border border-blue-100">
                            ...
                            {targetedCerts.length > 0 ? (
                                    ...
                                    {targetedCerts.map((cert: any, i: number) => {
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                className="flex items-center gap-3 p-3 bg-slate-50/80 hover:bg-blue-50/30 border border-slate-100 hover:border-blue-100 rounded-2xl transition-all duration-200 group"
                                            >
                                                {logo.endsWith('.svg') || logo.endsWith('.png') ? (
                                                    <img src={logo} alt={cert.nom} className="w-9 h-9 object-contain group-hover:scale-105 transition-transform" />
                                                ) : (
                                                ...
                                                <div className="flex-1 min-w-0 text-left">
                                                    <p className="text-[9px] font-extrabold text-blue-600 uppercase tracking-tight leading-none">
                                                        {cert.codeExamen || 'Examen'}
                                                    </p>
                                                    <p className="text-xs font-bold text-slate-800 truncate group-hover:text-blue-900 transition-colors mt-0.5">
                                                        {cert.nom}
                                                    </p>
                                                </div>
                                                <a 
                                                    href={`/dashboard/practice?cert=${cert.slug}`} 
                                                    className="p-1.5 bg-white border border-slate-200 hover:border-blue-300 rounded-xl hover:bg-blue-600 text-slate-400 hover:text-white transition-all duration-200 shadow-sm opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0"
                                                    title="S'entraîner"
                                                >
                                ...
                                <div className="text-center py-6 space-y-3">
                                    ...
                                    <a 
                                        ...
                                        className="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-[10px] rounded-xl transition-all duration-200 shadow-md shadow-blue-600/20 hover:scale-[1.02]"
                                    >
