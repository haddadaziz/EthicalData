...
import { CheckCircle, ArrowRight, ShieldCheck, Clock, Phone } from '@/components/icons';
...
export default function PortageSalarialPage() {
  return (
    <main className="min-h-screen bg-[#020617] text-white relative overflow-hidden font-sans">
      ...
      {/* SECTION 1: PORTAGE SALARIAL (SPLIT LAYOUT) */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6">
              <div className="relative rounded-3xl overflow-hidden border border-slate-800 bg-[#080d1a] p-3 shadow-2xl group">
                <img
                  ...
                  alt="Portage salarial - Autonomie et sérénité"
            ...
            <div className="lg:col-span-6 space-y-6 text-left">
              ...
              <div className="space-y-4 text-slate-300 text-xs sm:text-sm md:text-base leading-relaxed font-normal">
                <p>
                  Le portage salarial, c&apos;est une façon innovante pour les travailleurs indépendants d&apos;exercer leur activité professionnelle sans avoir à créer leur propre entreprise. En effet, cette forme d&apos;emploi implique une relation tripartite entre le travailleur indépendant, une société de portage salarial et ses clients.
                </p>
                <p>
                  Concrètement, le professionnel en portage conserve son autonomie dans l&apos;organisation de son travail tout en bénéficiant du soutien administratif, financier et juridique de la société de portage. Cette dernière agit à la fois comme un tiers employeur pour le professionnel et comme un intermédiaire dans ses relations commerciales avec ses clients.
                </p>
                <p>
                  Contrairement à un salarié traditionnel, le travailleur en portage salarial reste maître de sa clientèle et négocie directement avec ses clients les conditions de ses prestations, telles que la nature, les modalités d&apos;exécution, la durée et le tarif. Ensuite, la société de portage salarial formalise ces accords en signant un contrat de service avec le client, tandis que le professionnel signe un contrat de sous-traitance en portage salarial avec la société de portage.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 lg:order-2">
              <div className="relative rounded-3xl overflow-hidden border border-slate-800 bg-[#080d1a] p-3 shadow-2xl group">
                <img
                  ...
                  alt="Avantages du portage salarial"
                  className="w-full h-[350px] md:h-[430px] object-cover rounded-2xl group-hover:scale-105 transition-transform duration-500"
                  loading="lazy"
                  decoding="async"
                />
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <div className="bg-[#080d1a] border border-slate-800 rounded-3xl p-8 md:p-12 space-y-6 shadow-2xl">
            ...
            <p className="text-slate-300 text-xs md:text-sm max-w-xl mx-auto leading-relaxed">
              Découvrez comment notre solution de portage salarial peut sécuriser vos facturations et simplifier votre activité.
            </p>
