                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredCourses.map((course) => (
                        <div
                            ...
                            className="group bg-[#080d1a] border border-blue-900/50 shadow-[0_0_25px_rgba(30,58,138,0.05)] rounded-2xl overflow-hidden hover:shadow-[0_0_35px_rgba(30,58,138,0.2)] hover:border-blue-700/60 transition-all duration-300 flex flex-col"
                        >
                            {/* Image Header */}
                            <div onClick={() => router.push(`/admin/courses/${course.id}`)} className="relative w-full h-[200px] bg-gradient-to-br from-slate-800/50 to-slate-900/50 cursor-pointer">
                                {course.imageUrl ? (
                                    <img src={course.imageUrl} alt={course.titre} loading="lazy" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                                ) : (
                            ...
                            <div className="p-4 flex-1 flex flex-col gap-2">
                                ...
                                <div className="flex items-center gap-1.5 text-[10px] text-slate-400 font-semibold pt-1 border-t border-slate-800">
                                    <div className="w-5 h-5 rounded-full bg-blue-950/30 text-cyan-400 flex items-center justify-center text-[8px] font-black shrink-0 overflow-hidden">
                                        {course.formateur?.avatar ? (
                                            <img src={course.formateur.avatar} alt="" loading="lazy" className="w-full h-full object-cover rounded-full" />
                                        ) : (
                                ...
                                <button
                                    ...
                                    className="self-start flex items-center gap-1.5 px-3 py-1.5 bg-[#020617] border border-slate-800 hover:border-slate-700 text-[10px] font-extrabold text-cyan-400 hover:text-white rounded-lg transition-all cursor-pointer hover:scale-[1.03] active:scale-95 shadow-sm"
                                >
                                    <span>Consulter</span>
                            ...
                            <div className="border-t border-slate-800 p-3 flex items-center gap-2 bg-[#020617]">
                                <button
                                    ...
                                    className="flex-1 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-lg shadow-blue-600/20 active:scale-95"
                                >
