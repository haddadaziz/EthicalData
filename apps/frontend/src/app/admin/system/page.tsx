...
export default function SystemSettingsPage() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <span className="w-10 h-10 border-4 border-slate-800 border-t-cyan-400 rounded-full animate-spin" />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 bg-[#020617]">
      {/* Barre d'onglets premium style capsule */}
      <div className="flex bg-[#080d1a] p-1.5 rounded-2xl border border-slate-800 overflow-x-auto gap-1">
        {tabs.map((tab) => {
          const Icon = tab.icon;
      ...
      <div className="relative min-h-[50vh]">
        <AnimatePresence mode="wait">
          {activeTab === 'general' && (
            ...
            >
              <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
                <div className="w-10 h-10 rounded-xl bg-blue-950/30 border-0 flex items-center justify-center text-cyan-400 shrink-0">
                  <Globe className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-base font-black text-white tracking-tight">Paramètres Généraux</h3>
                  <p className="text-xs text-slate-400 font-semibold">Configurez l'identité visuelle et les accès publics de la plateforme.</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-300">Nom du site *</label>
                  <input
                    type="text"
                    required
                    value={general.siteName}
                    onChange={(e) => setGeneral({ ...general, siteName: e.target.value })}
                    className="w-full px-4 py-2.5 bg-[#020617] border border-slate-800 focus:border-blue-600 focus:bg-slate-900/50 text-white placeholder:text-slate-500 rounded-xl text-xs font-semibold outline-none transition-all"
                  />
                </div>

                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-300">Adresse email de contact *</label>
                  <input
                    type="email"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-300">Téléphone de support</label>
                  <input
                    type="text"
                ...
                <div className="space-y-1.5 flex flex-col justify-end">
                  <label className="flex items-center justify-between p-3.5 bg-[#020617] border border-slate-800 rounded-xl cursor-pointer hover:bg-slate-800/50 transition-colors">
                    <div className="space-y-0.5 text-left">
                      <h4 className="text-xs font-bold text-white">Autoriser les inscriptions publiques</h4>
                      <p className="text-[10px] text-slate-400 font-medium">Permet aux nouveaux apprenants de créer leur compte.</p>
                    </div>
                    <input
                      type="checkbox"
          ...
          {activeTab === 'security' && (
            ...
            >
              <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
                <div className="w-10 h-10 rounded-xl bg-rose-950/30 border-0 flex items-center justify-center text-rose-400 shrink-0">
                  <ShieldCheck className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-base font-black text-white tracking-tight">Sécurité & Anti-Partage</h3>
                  <p className="text-xs text-slate-400 font-semibold">Définissez la politique de sécurité des accès et gérez le contrôle anti-partage.</p>
                </div>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="text-xs font-black text-white uppercase tracking-wider mb-3">Complexité des Mots de Passe</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Longueur minimale</label>
                      <input
                        type="number"
                        min={6}
                        max={30}
                ...
                <div>
                  <h4 className="text-xs font-black text-white uppercase tracking-wider mb-3">Téléchargements & Session</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Quota de téléchargements par jour (par défaut)</label>
                      <input
                        type="number"
                        min={1}
                        required
                    ...
                    <div className="flex items-end">
                      <label className="w-full flex items-center justify-between p-3 bg-[#020617] border border-slate-800 rounded-xl cursor-pointer hover:bg-slate-800/50 transition-colors">
                        <div className="space-y-0.5 text-left">
                          <h4 className="text-xs font-bold text-white">Règle anti-partage de compte</h4>
                          <p className="text-[10px] text-slate-400 font-medium">Empêche les connexions simultanées depuis des IPs différentes.</p>
                        </div>
                        <input
                          type="checkbox"
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-300">Liste noire d'adresses IP (une par ligne)</label>
                  <textarea
                    rows={4}
                    value={rawBannedIps}
          ...
          {activeTab === 'ai' && (
            ...
            >
              <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
                <div className="w-10 h-10 rounded-xl bg-purple-950/30 border-0 flex items-center justify-center text-purple-400 shrink-0">
                  <Sparkles className="w-5 h-5 text-purple-400" />
                </div>
                <div>
                  <h3 className="text-base font-black text-white tracking-tight">Configuration IA Universelle</h3>
                  <p className="text-xs text-slate-400 font-semibold">Gérez les modèles de langage (Gemini, OpenAI, etc.) et le prompt système pour la notation et l'assistant IA.</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-300">Modèle actif *</label>
                  <input
                    list="ai-models"
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-300">URL de Base API (Optionnel)</label>
                  <input
                    type="url"
                    value={ai.apiUrl || ''}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-300">Clé d'API (OpenAI, Gemini, Groq...)</label>
                  <input
                    type="password"
                    value={ai.apiKey}
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-300">Limite de jetons max (maxTokens)</label>
                  <input
                    type="number"
                    min={256}
                    max={16384}
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  <label className="text-xs font-bold text-slate-300">Prompt système / Instructions d'évaluation</label>
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-[#020617] border border-slate-800 focus:border-blue-600 focus:bg-slate-900/50 text-white placeholder:text-slate-500 rounded-xl text-xs font-semibold outline-none transition-all resize-none"
                />
              </div>
          ...
          {activeTab === 'integrations' && (
            ...
            >
              <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
                <div className="w-10 h-10 rounded-xl bg-amber-950/30 border-0 flex items-center justify-center text-amber-400 shrink-0">
                  <LinkIcon className="w-5 h-5 text-amber-400" />
                </div>
                <div>
                  <h3 className="text-base font-black text-white tracking-tight">Intégrations & Webhooks</h3>
                  <p className="text-xs text-slate-400 font-semibold">Configurez la liaison avec Stripe et les notifications sur vos salons de communication.</p>
                </div>
              </div>

              <div className="space-y-6">
                <div>
                  <h4 className="text-xs font-black text-white uppercase tracking-wider mb-3">Salons de Communication (Logs & Alertes)</h4>
                  <div className="grid grid-cols-1 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Webhook Discord</label>
                      <input
                        type="url"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Webhook Slack</label>
                      <input
                        type="url"
                ...
                <div>
                  <h4 className="text-xs font-black text-white uppercase tracking-wider mb-3">Passerelle de Paiement Stripe</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Clé Publique Stripe (Publishable Key)</label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Clé Secrète Stripe (Secret Key)</label>
                      <input
                        type="password"
                ...
                <div>
                  <h4 className="text-xs font-black text-white uppercase tracking-wider mb-3">Serveur SMTP (Emails transactionnels)</h4>
                  <p className="text-[10px] text-slate-400 font-medium mb-4">Configurez le serveur SMTP pour l'envoi d'emails (réinitialisation de mot de passe, notifications, etc.).</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Hôte SMTP</label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Port SMTP</label>
                      <input
                        type="number"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Utilisateur SMTP</label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Mot de passe SMTP</label>
                      <input
                        type="password"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-slate-300">Email expéditeur</label>
                      <input
                        type="email"
                    ...
                    <div className="flex items-end">
                      <label className="w-full flex items-center justify-between p-3 bg-[#020617] border border-slate-800 rounded-xl cursor-pointer hover:bg-slate-800/50 transition-colors">
                        <div className="space-y-0.5 text-left">
                          <h4 className="text-xs font-bold text-white">Connexion sécurisée (TLS)</h4>
                          <p className="text-[10px] text-slate-400 font-medium">Utiliser SSL/TLS pour la connexion SMTP.</p>
                        </div>
                        <input
                          type="checkbox"
