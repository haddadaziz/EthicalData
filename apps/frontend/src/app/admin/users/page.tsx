...
export default function AdminUsersPage() {
                ...
                {paginatedUsers.map((user) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start justify-between gap-3">
                                    <div className="flex items-center gap-3">
                                        {user.avatar ? (
                                            <img src={user.avatar} alt={user.prenom} className="w-11 h-11 rounded-2xl object-cover border border-slate-800 shadow-sm" />
                                        ) : (
                                ...
                                <div className="flex items-center gap-2 pt-1">
                                    <span className={`px-2.5 py-0.5 rounded-full font-extrabold text-[9px] uppercase tracking-wider ${mainRole === 'SUPER_ADMIN' || mainRole === 'ADMIN' ? 'bg-purple-950/30 text-purple-300' : mainRole === 'FORMATEUR' ? 'bg-blue-950/30 text-cyan-300' : 'bg-slate-900/50 text-slate-300'
                                        }`}>
                                        {mainRole}
                                    </span>

                                    <span className={`px-2.5 py-0.5 rounded-full font-extrabold text-[9px] uppercase tracking-wider ${user.statut === 'ACTIF' ? 'bg-emerald-950/30 text-emerald-300' : user.statut === 'BANNI' ? 'bg-rose-950/30 text-rose-400' : 'bg-amber-950/30 text-amber-300'
                                        }`}>
                                        {user.statut}
                                    </span>
                                </div>
                            ...
                            <div className="space-y-1.5 pt-3 border-t border-slate-800 text-xs font-medium text-slate-400">
    ...
    if (loading) {
        return (
            <div className="p-16 text-center text-slate-400 bg-[#080d1a] border border-slate-800 rounded-3xl max-w-5xl mx-auto">
                ...
                <p className="text-xs font-bold uppercase tracking-widest text-cyan-400">Chargement des utilisateurs...</p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto text-left">
            ...
            <div className="bg-[#080d1a] border border-slate-800 rounded-3xl p-4 md:p-5 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="space-y-1">
                                <h3 className="text-lg font-black text-white">Créer un nouvel utilisateur</h3>
                                <p className="text-xs text-slate-400 font-medium">Ajoutez un candidat, formateur ou administrateur.</p>
                            </div>
                            ...
                            <form onSubmit={handleCreateUser} className="space-y-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full p-3.5 pr-11 bg-[#020617] border border-slate-800 focus:border-blue-600 focus:bg-slate-900/50 text-white placeholder:text-slate-500 rounded-2xl text-xs font-semibold outline-none"
                                        />
                                        <button
                                            type="button"
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-slate-300">Rôle *</label>
                                    <select
                                        value={newRole}
                ...
                {selectedUser && (
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="space-y-1">
                                <h3 className="text-lg font-black text-white">Modifier le Compte</h3>
                            ...
                            <form onSubmit={handleUpdateUser} className="space-y-4">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-slate-300">Attribuer un Rôle *</label>
                                    <select
                                        value={editRole}
