        ...
        <div className="flex items-center gap-1 md:gap-3">
          {!mounted ? (
            ...
            <a
              ...
              className="px-2.5 py-1.5 md:px-5 md:py-2.5 bg-gradient-to-r from-blue-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white text-[9px] md:text-xs font-black uppercase tracking-wider rounded-md md:rounded-xl transition-all shadow-md shadow-blue-600/30 cursor-pointer hover:scale-105 active:scale-95"
            >
              Mon Espace
            </a>
          ) : (
            <>
              <a href="/login" className={`hidden md:inline-flex px-4 text-xs font-black uppercase tracking-wider transition-colors cursor-pointer ${scrolled ? 'text-slate-300 hover:text-cyan-400' : 'text-white/80 hover:text-white'}`}>
                Connexion
              </a>
              <Link
                href="/register"
