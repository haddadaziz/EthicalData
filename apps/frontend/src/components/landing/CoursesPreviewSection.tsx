  ...
  return (
    <section className="relative z-10 bg-[#020617] border-t border-slate-900 overflow-hidden">
      <BackgroundBeamsWithCollision className="py-20 px-4 md:px-6">
        <div className="max-w-7xl mx-auto text-left relative z-20 w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {FEATURED_COURSES.map((course) => (
              <div
                key={course.id}
                className="bg-[#080d1a]/90 backdrop-blur-md border border-slate-800 hover:border-slate-700 rounded-3xl overflow-hidden flex flex-col justify-between transition-all shadow-xl hover:shadow-cyan-950/20 group"
              >
                {/* Banner Image */}
