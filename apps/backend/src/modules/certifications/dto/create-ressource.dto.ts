...
export class CreateRessourceDto {
  ...
  @IsString()
  @IsNotEmpty({
    message: 'Le type de la ressource (ex: PDF, SLIDES) est obligatoire.',
  })
  type: string;
  ...
  @IsNumber(
    {},
    {
      message: 'La certification associée doit être un identifiant numérique.',
    },
  )
  @IsOptional()
  ...
  @IsNumber(
    {},
    { message: 'Le cours associé doit être un identifiant numérique.' },
  )
  @IsOptional()
  coursId?: number;
}
